...
class AdminController {
   ...
   * @access  Private/Admin
   */
  getAllPublishers = asyncHandler(async (req: AuthRequest, res: Response, _next: NextFunction) => {
    ...
    const result = await adminService.getAllPublishers(filters, Number(page), Number(limit));
   ...
   * @access  Private/Admin
   */
  getPublisherDetails = asyncHandler(async (req: AuthRequest, res: Response, _next: NextFunction) => {
    const { id } = req.params;

    const details = await adminService.getPublisherDetails(id);

    sendSuccess(res, 200, 'Publisher details retrieved successfully', details);
  });
   ...
   * @access  Private/Admin
   */
  updatePublisherLevel = asyncHandler(async (req: AuthRequest, res: Response, _next: NextFunction) => {
    const { id } = req.params;
    const { accountLevel } = req.body;

    const publisher = await adminService.updatePublisherLevel(id, accountLevel);

    sendSuccess(res, 200, 'Publisher level updated successfully', { publisher });
  });
   ...
   * @access  Private/Admin
   */
  updatePublisherStatus = asyncHandler(async (req: AuthRequest, res: Response, _next: NextFunction) => {
    const { id } = req.params;
    const { accountStatus } = req.body;

    const publisher = await adminService.updatePublisherStatus(id, accountStatus);

    sendSuccess(res, 200, 'Publisher status updated successfully', { publisher });
  });
   ...
   * @access  Private/Admin
   */
  getAllWebsites = asyncHandler(async (req: AuthRequest, res: Response, _next: NextFunction) => {
    const { status, page = 1, limit = 20 } = req.query;

    const filters: any = {};
    if (status) filters.status = status;

    const result = await websitesService.getAllWebsites(filters, Number(page), Number(limit));
   ...
   * @access  Private/Admin
   */
  verifyWebsite = asyncHandler(async (req: AuthRequest, res: Response, _next: NextFunction) => {
    const { id } = req.params;
  ...
  sendCounterOffer = asyncHandler(async (req: AuthRequest, res: Response, _next: NextFunction) => {
    ...
    const website = await websitesService.sendCounterOffer(id, { notes, terms });
   ...
   * @access  Private/Admin
   */
  updateWebsiteStatus = asyncHandler(async (req: AuthRequest, res: Response, _next: NextFunction) => {
    const { id } = req.params;
    const { status, rejectionReason } = req.body;

    const website = await websitesService.updateWebsiteStatus(id, status, rejectionReason);
   ...
   * @access  Private/Admin
   */
  getAllOrders = asyncHandler(async (req: AuthRequest, res: Response, _next: NextFunction) => {
    ...
    const result = await ordersService.getAllOrders(filters, Number(page), Number(limit));
   ...
   * @access  Private/Admin
   */
  createOrder = asyncHandler(async (req: AuthRequest, res: Response, _next: NextFunction) => {
   ...
   * @access  Private/Admin
   */
  updateOrder = asyncHandler(async (req: AuthRequest, res: Response, _next: NextFunction) => {
    const { id } = req.params;
   ...
   * @access  Private/Admin
   */
  updateOrderStatus = asyncHandler(async (req: AuthRequest, res: Response, _next: NextFunction) => {
    const { id } = req.params;
   ...
   * @access  Private/Admin
   */
  getAllPayments = asyncHandler(async (req: AuthRequest, res: Response, _next: NextFunction) => {
    const { status, page = 1, limit = 20 } = req.query;

    const filters: any = {};
    if (status) filters.status = status;

    const result = await paymentsService.getAllPayments(filters, Number(page), Number(limit));
   ...
   * @access  Private/Admin
   */
  generateInvoice = asyncHandler(async (req: AuthRequest, res: Response, _next: NextFunction) => {
   ...
   * @access  Private/Admin
   */
  processPayment = asyncHandler(async (req: AuthRequest, res: Response, _next: NextFunction) => {
    const { id } = req.params;
   ...
   * @access  Private/Admin
   */
  markPaymentAsPaid = asyncHandler(async (req: AuthRequest, res: Response, _next: NextFunction) => {
    const { id } = req.params;
   ...
   * @access  Private/Admin
   */
  getAllApplications = asyncHandler(async (req: AuthRequest, res: Response, _next: NextFunction) => {
    const { status, page = 1, limit = 20 } = req.query;

    const filters: any = {};
    if (status) filters.status = status;

    const result = await applicationsService.getAllApplications(filters, Number(page), Number(limit));
   ...
   * @access  Private/Admin
   */
  getApplicationById = asyncHandler(async (req: AuthRequest, res: Response, _next: NextFunction) => {
    const { id } = req.params;
   ...
   * @access  Private/Admin
   */
  approveApplication = asyncHandler(async (req: AuthRequest, res: Response, _next: NextFunction) => {
    const { id } = req.params;
    const reviewedBy = req.user!.id;

    const result = await applicationsService.approveApplication(id, reviewedBy);

    sendSuccess(res, 200, 'Application approved and user account created', result);
  });
   ...
   * @access  Private/Admin
   */
  rejectApplication = asyncHandler(async (req: AuthRequest, res: Response, _next: NextFunction) => {
    const { id } = req.params;
    const reviewedBy = req.user!.id;
    const { rejectionReason } = req.body;

    const application = await applicationsService.rejectApplication(id, reviewedBy, rejectionReason);
   ...
   * @access  Private/Admin
   */
  getAllTickets = asyncHandler(async (req: AuthRequest, res: Response, _next: NextFunction) => {
    ...
    const result = await supportService.getAllTickets(filters, Number(page), Number(limit));
   ...
   * @access  Private/Admin
   */
  assignTicket = asyncHandler(async (req: AuthRequest, res: Response, _next: NextFunction) => {
    const { id } = req.params;
   ...
   * @access  Private/Admin
   */
  updateTicketStatus = asyncHandler(async (req: AuthRequest, res: Response, _next: NextFunction) => {
    const { id } = req.params;
   ...
   * @access  Private/Admin
   */
  getAllBlogPosts = asyncHandler(async (req: AuthRequest, res: Response, _next: NextFunction) => {
   ...
   * @access  Private/Admin
   */
  createBlogPost = asyncHandler(async (req: AuthRequest, res: Response, _next: NextFunction) => {
   ...
   * @access  Private/Admin
   */
  getBlogPostById = asyncHandler(async (req: AuthRequest, res: Response, _next: NextFunction) => {
    const { id } = req.params;
   ...
   * @access  Private/Admin
   */
  updateBlogPost = asyncHandler(async (req: AuthRequest, res: Response, _next: NextFunction) => {
    const { id } = req.params;
   ...
   * @access  Private/Admin
   */
  deleteBlogPost = asyncHandler(async (req: AuthRequest, res: Response, _next: NextFunction) => {
    const { id } = req.params;
   ...
   * @access  Private/Admin
   */
  createCategory = asyncHandler(async (req: AuthRequest, res: Response, _next: NextFunction) => {
   ...
   * @access  Private/Admin
   */
  updateCategory = asyncHandler(async (req: AuthRequest, res: Response, _next: NextFunction) => {
    const { id } = req.params;
   ...
   * @access  Private/Admin
   */
  deleteCategory = asyncHandler(async (req: AuthRequest, res: Response, _next: NextFunction) => {
    const { id } = req.params;
   ...
   * @access  Private/Admin
   */
  getRecentActivity = asyncHandler(async (_req: AuthRequest, res: Response, _next: NextFunction) => {
